...
gen-cpp:
	...
	$(PROTOC) --cpp_out=./$(PROTO_GEN_CPP_DIR) --grpc-cpp_out=./$(PROTO_GEN_CPP_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-csharp:
	...
	$(PROTOC) --csharp_out=./$(PROTO_GEN_CSHARP_DIR) --grpc-csharp_out=./$(PROTO_GEN_CSHARP_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-go:
	...
	$(PROTOC) --grpc-gateway_out=logtostderr=true,grpc_api_configuration=opentelemetry/proto/collector/events/v1/events_service_http.yaml:./$(PROTO_GEN_GO_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-js:
	...
	$(PROTOC) --js_out=import_style=commonjs:./$(PROTO_GEN_JS_DIR) --grpc-web_out=import_style=commonjs,mode=grpcweb:./$(PROTO_GEN_JS_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-objc:
	...
	$(PROTOC) --objc_out=./$(PROTO_GEN_OBJC_DIR) --grpc-objc_out=./$(PROTO_GEN_OBJC_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-openapi:
	...
	$(PROTOC) --openapiv2_out=logtostderr=true,grpc_api_configuration=opentelemetry/proto/collector/events/v1/events_service_http.yaml:$(PROTO_GEN_OPENAPI_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-php:
	...
	$(PROTOC) --php_out=./$(PROTO_GEN_PHP_DIR) --grpc-php_out=./$(PROTO_GEN_PHP_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-python:
	...
	$(PROTOC) --python_out=./$(PROTO_GEN_PYTHON_DIR) --grpc-python_out=./$(PROTO_GEN_PYTHON_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
...
gen-ruby:
	...
	$(PROTOC) --ruby_out=./$(PROTO_GEN_RUBY_DIR) --grpc-ruby_out=./$(PROTO_GEN_RUBY_DIR) opentelemetry/proto/collector/events/v1/events_service.proto
